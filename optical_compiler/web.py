    ...
    <div class="scenario-controls-container">
      ...
      <div class="scenario-select-group">
        ...
        <select class="scenario-select" id="cameraPresetSelect" onchange="onCameraPresetSelectChange()">
          ...
          <optgroup label="👑 Medium Format Tri-Signatures (Verified Master Suites)">
            <option value="cam_module_a_phase_one_110mm">Module A: Phase One IQ4 151MP // Schneider 110mm LS f/2.8 (Resolving Authority)</option>
            <option value="cam_module_b_hasselblad_90v">Module B: Hasselblad X2D II 100MP // XCD 90mm f/2.5 V (HNCS HDR Tonal Realism)</option>
            <option value="cam_module_c_fujifilm_110mm">Module C: Fujifilm GFX100 II 102MP // Fujinon GF 110mm f/2 (Portrait Precision)</option>
          </optgroup>
          ...
          <optgroup label="🇩🇪 Leica Rangefinders & Precision Optics">
            ...
            <option value="cam_leica_sl3_p_apo_90mm">Leica SL3-P 45MP // APO-Summicron-SL 90mm f/2 ASPH (Architect Cantilever)</option>
            <option value="cam_leica_m11_summicron_apo_50mm">Leica M11 60MP // APO-Summicron-M 50mm f/2 ASPH (Watchmaker Atelier Micro-Contrast)</option>
            <option value="cam_leica_m11_noctilux_75mm">Leica M11 60MP // Noctilux-M 75mm f/1.25 ASPH (Cellist Velvet Bokeh Intermission)</option>
            <option value="cam_leica_m11_summicron_90mm">Leica M11 60MP // APO-Summicron-M 90mm f/2 ASPH (Rain-Slicked Boulevard Flaneur)</option>
            <option value="cam_leica_m11_summilux_35mm_asph_ii">Leica M11 60MP // Summilux-M 35mm f/1.4 ASPH II (Latin Quarter Photojournalist)</option>
          </optgroup>
          ...
          <optgroup label="⚡ Flagship Stacked & High-Resolution Systems">
            ...
            <option value="cam_canon_eos_r6_iii_allrounder">Canon EOS R6 Mark III 32.5MP // RF 24-70mm f/2.8L (All-Rounder Architect Studio)</option>
            <option value="cam_nikon_z5_ii_allrounder">Nikon Z 5 II 24MP // NIKKOR Z 24-70mm f/4 S (All-Rounder Documentary Craft)</option>
